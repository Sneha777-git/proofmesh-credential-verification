  ...
  head: () => ({
    meta: [
      ...
      { title: "ProofMesh — Verify Trust. Prove Authenticity." },
      {
        name: "description",
        content:
          "Web3 credential verification: document, SHA-256 fingerprint, blockchain proof, independent verification.",
      },
      { property: "og:title", content: "ProofMesh — Verify Trust. Prove Authenticity." },
      {
        property: "og:description",
        content: "Independent verification of credential proofs anchored on Ethereum Sepolia.",
      },
